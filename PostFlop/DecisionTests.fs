...
module DecisionTests =
  ...
  let riverBetSizeTest stack expected =
    let snapshot = { defaultRiver with Pot = 200; HeroStack = stack }
    let options = { defaultOopOptions with First = RiverBetSizing }
